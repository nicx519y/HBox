...
enum class MessageId {
    ...
    GPIO_BTNS_STATE_CHANGED = 1,
    ADC_BTNS_STATE_CHANGED = 2,
    ...
    ADC_BTNS_MARKER_SETUP = 7,
    ADC_BTNS_MARKER_STEP_START = 8,
    ADC_BTNS_MARKER_STEP_FINISH = 9,
    ADC_BTNS_MARKER_FINISH = 10,
